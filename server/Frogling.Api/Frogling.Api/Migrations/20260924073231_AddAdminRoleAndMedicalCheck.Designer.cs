...
namespace Frogling.Api.Migrations
{
    ...
    [Migration("20260924073231_AddAdminRoleAndMedicalCheck")]
    partial class AddAdminRoleAndMedicalCheck
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Frogling.Api.Models.User", b =>
                {
                    ...
                    b.Property<bool>("IsMedicalCheckValid")
                        .HasColumnType("bit");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 9, 24, 7, 32, 31, 704, DateTimeKind.Utc).AddTicks(5196),
                            Email = "admin@frogling.ru",
                            FullName = "Главный Администратор",
                            IsMedicalCheckValid = true,
                            ParentName = "",
                            PasswordHash = "$2a$11$z3sBb1mpCpXH8JuA.oW6k.Q3XMrWZ/Bxif.qyx9bQ3IeJxAZA3Ype",
                            Phone = "",
                            Role = "Admin"
                        });
                });
