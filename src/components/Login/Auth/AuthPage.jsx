...
export default function AuthPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Имитация задержки ответа сервера (1 секунда)
      ...
      setNotification({
        type: 'success',
        message: isLogin ? 'Успешный вход! Перенаправление...' : 'Регистрация завершена успешно!'
      });

      // Перенаправляем на главную страницу сайта через 500мс
      setTimeout(() => {
