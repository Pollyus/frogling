    ...
    return (
        <div className={styles.headerSection}>
            ...
            <div className={styles.headerContent}>
                ...
                <p>Место, где рождается любовь к воде! Обучение плаванию для детей от 3 месяцев до 8 лет, безопасная и комфортная среда, укрепление здоровья вашего ребенка </p>
            </div>
        </div>
    );
};
